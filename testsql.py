...
for line in data:
	...
	if len(line) <> 15:
		print line
	query7 = ("insert into finall(id, dept, name, title, salary, first, gender, percent, percentile, rank, first2, gender2, percent2, percentile2, rank2) values('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');" % (line[0], line[1], line[2], line[3], line[4], line[5], line[6], line[7], line[8], line[9], line[10], line[11], line[12], line[13], line[14]))
	cursor.execute(query7)
query8 = ("insert into final(id, dept, name, title, salary, first, gender, percent, percentile, rank, first2, gender2, percent2, percentile2, rank2) values('1','Department of public works', 'Wildfire McGee', 'Badass', '132.40', 'Wildfire', 'F', '0.003', '3.02', '666', 'none', 'none', 'none', 'none', 'none')")
print query8
